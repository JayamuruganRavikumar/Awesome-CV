...
\newtoggle{lang_eng}
\settoggle{lang_eng}{true} % True for english and false for German
...
\photo[circle,edge,left]{../examples/profile}
\name{Byungjin}{Park}
...
%-------------------------------------------------------------------------------
\iftoggle{lang_eng}
{\input{resume/summary_eng.tex}}
{\input{resume/summary.tex}}

\iftoggle{lang_eng}
{\input{resume/Experience_eng.tex}}
{\input{resume/experience.tex}}

\iftoggle{lang_eng}
{\input{resume/honors_eng.tex}}
{\input{resume/honors.tex}}

\iftoggle{lang_eng}
{\input{resume/certificates_eng.tex}}
{\input{resume/certificates.tex}}
% \input{resume/presentation.tex}
% \input{resume/writing.tex}
% \input{resume/committees.tex}
\iftoggle{lang_eng}
{\input{resume/education_eng.tex}}
